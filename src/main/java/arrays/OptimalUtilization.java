...
//        Combined, they add up to 10. Similarily, element with id = 3 from `a` has a value 7, and element with id = 2
//        from `b` has a value 3.
...
public class OptimalUtilization {
    public int bruteForce(int[] A, int[] B, int target) {
